...
"""
This file is used to generate the plots in section '4.1 ICE & PD' of the paper.
It processes the result files (in experiments/ice_pd/results) generated by running experiments/ice_pd/runtime_benchmark.py.
"""
